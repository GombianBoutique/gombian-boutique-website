  ...
  if (query.q) {
    ...
    filteredProducts = filteredProducts.filter(
      product =>
        ...
        product.scentNotes.top.some(note => note.toLowerCase().includes(searchTerm)) ||
        product.scentNotes.middle.some(note => note.toLowerCase().includes(searchTerm)) ||
        product.scentNotes.base.some(note => note.toLowerCase().includes(searchTerm))
    )
  }
