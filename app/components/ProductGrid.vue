    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
      ...
      <div class="flex flex-wrap gap-4">
        ...
        <div class="flex items-center space-x-2">
          <button 
            @click="viewMode = 'grid'"
            :class="['p-2 rounded-md', viewMode === 'grid' ? 'bg-gold text-luxury-green' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300']"
          ...
          <button 
            @click="viewMode = 'list'"
            :class="['p-2 rounded-md', viewMode === 'list' ? 'bg-gold text-luxury-green' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300']"
      ...
      <div v-for="product in displayedProducts" :key="product.id" :class="viewMode === 'list' ? 'flex' : ''">
        ...
        <div v-if="viewMode === 'list'" class="ml-6 flex-grow">
          ...
          <div class="flex items-center mb-4">
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400">({{ product.reviewCount }} reviews)</span>
          </div>
